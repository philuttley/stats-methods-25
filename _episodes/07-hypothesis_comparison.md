...
and then to calculate a statistical measure of how extreme our data are compared to that null hypothesis. This measure is formalized as a $p$-value: the probability of 
